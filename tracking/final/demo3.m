...
srcFiles = dir('/home/sahdev/Desktop/Fall2015/ComputerVision5323/project_ideas/moving_camera/set8/*.png');  % the folder in which ur images exists
n = length(srcFiles);
labels = cell(n,1);

parfor i = 1 : n
    filename = strcat('/home/sahdev/Desktop/Fall2015/ComputerVision5323/project_ideas/moving_camera/set8/',srcFiles(i).name);
