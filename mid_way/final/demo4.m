...
boundary_effect = 15;
threshold = 900; % this is the threshold for the harris corner detector

srcFiles = dir('/home/sahdev/Desktop/Fall2015/ComputerVision5323/project_ideas/moving_camera/set1/*.png');  % the folder in which ur images exists
n = length(srcFiles);
labels = cell(n,1);

parfor i = 1 : n
    filename = strcat('/home/sahdev/Desktop/Fall2015/ComputerVision5323/project_ideas/moving_camera/set1/',srcFiles(i).name);
